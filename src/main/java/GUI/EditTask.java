...
public class EditTask extends javax.swing.JDialog {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(EditTask.class.getName());
    private Task currentTask;
    /**
     * Creates new edit task form
     */
    public EditTask(java.awt.Frame parent, boolean modal,Task task) {
        super(parent, modal);
        initComponents();
        ...
        this.getContentPane().requestFocusInWindow(); //stop the focus being on the first input field
         ...
         if (this.currentTask != null) {
            ...
            dueDateField.setText(currentTask.getDueDate());
            ...
            for (int i = 0; i < assignedUserDropDown.getItemCount(); i++) {
                User u = assignedUserDropDown.getItemAt(i);
                if (u.getUserID() == currentTask.getAssignedUser()) {
                    assignedUserDropDown.setSelectedIndex(i);
                    break;
                }
            }
        }
   ...
   private void showError(String message) {
    ...
    private void saveBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_saveBtnMouseClicked
        ...
        if(validateInputs()){
            //Map UI values back to the currentTask object
            currentTask.setTaskName(taskNameField.getText().trim());
            currentTask.setTaskDescription(descriptionTxtArea.getText().trim());
            currentTask.setDueDate(dueDateField.getText().trim());
